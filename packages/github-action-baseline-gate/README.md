...
| `cellfence-version` | no | `0.4.0` | CellFence release version this bundled gate is paired with. The action itself does not invoke the CLI; it reads the two baseline files directly. |
